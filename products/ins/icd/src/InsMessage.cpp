...
InsMessage::InsMessage(int sleepTimeBetweenEverySend) : m_sleepTimeBetweenEverySend(sleepTimeBetweenEverySend) {

}

void InsMessage::GetDataValidityBitfield(char* buffer, size_t bufferSize) const {
	unsigned char D1 = 0, D2 = 0;
	D1 =	1 << 7 | // position validity
	...
	D2 =	1 << 7 | // IPPS Validity - NOT IN USE!
...
void InsMessage::GetSystemStatusBitfield(char* buffer, size_t bufferSize) const {
	unsigned char S1 = 0, S2 = 0, S3 = 0, S4 = 0, S5 = 0, S6 = 0, S7 = 0, S8 = 0;

	S1 =	1 << 7 | // initialization mode
	...
	S2 =	0 << 7 | // zero-velocity update in progress
			1 << 6 | // GPS data valid
...
void InsMessage::GetSystemAlertBitfield(char* buffer, size_t bufferSize) const {
	unsigned char A1 = 0, A2 = 0, A3 = 0, A4 = 0, A5 = 0, A6 = 0, A7 = 0, A8 = 0, A9 = 0, A10 = 0;
